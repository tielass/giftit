class GiftsController < ApplicationController
  ...
  def index
    ...
    @hiking_gifts = Gift.where(category: "Hiking").sample(10)
    @technology_gifts = Gift.where(category: "Technology").sample(10)
    @chocolate_gifts = Gift.where(category: "Chocolate").sample(2)
    @food_gifts = Gift.where(category: "Food").sample(2)
    @cooking_gifts = Gift.where(category: "Cooking").sample(10)
    ...
    @yoga_gifts = Gift.where(category: "Yoga").sample(10)
